      ...
      body: Stack(
        children: <Widget>[
          ...
          SingleChildScrollView(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(300, 35, 300, 40), //MediaQuery provides widget to rebuild automatically
              child: Column(
                ...
                Container(
                        width: 450, 
                        child: EditCustomizeMirrorButton(context, false, () { //save the customized settings to the database
                    _authService
                        .EditCustomizeButton(
                      dwtime.toString(),
                      dwdate.toString(),
