              ...
              padding: EdgeInsets.all(MediaQuery.of(context).size.width / 20),
                child: Column(
                  children: <Widget>[    
                                       Container(
                        width: 350, 
                        child:reusableTitleField("CHANGE PASSWORD", false),    
                                       ),
                    const SizedBox(height: 30),
                                       Container(
                        width: 350, 
                        child:reusableTextField( //  for password
                        "Enter Old Password",
                    ...
                    const SizedBox(height: 20),
                     ...
                     Container(
                        width: 350, 
                        child:reusableTextField("Enter New Password", Icons.lock_outlined,  //  for new password
                    ...
                    const SizedBox(
                     ...
                     Container(
                        width: 350, 
                        child:updateButton(context, () async {
                     ...
                     Container(
                        width: 350, 
                        child:reusableTitleField("DELETE ACCOUNT", false), //  for delete account
                    ),
                       Container(
                        width: 350, 
                        child:reusableTitleField(
