...
class _ReminderScreenState extends State<ReminderScreen> {
  ...
  @override
  void initState() {   // This is to reach database instances about current user...
    super.initState();      //  But, Firebase authentication part can be reachedin this case... 
    getText(); //   This is to reach database instances about current user...
  }
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                        width: 350, 
                        child: CustomizeMirrorButton(context, false, () {
