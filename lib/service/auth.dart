...
class AuthService { //class for the connection with the firebase and the storage
  ...
  //kayıt ol fonksiyonu
  Future<User?> createPerson(String name, String surname, String email,   //createPerson function for the registration
      String password, DateTime birth, String gender, String country , bool defaultuser) async {
 ...
 Future<void> updatePerson(String userName, String userSurname, String country, //update the data
      String gender, DateTime birth) async {
  ...
  Future<void> customizeButton(   //save the pereferences of customization to the firebase
      String wtime,
      String wdate,
      String wweather,
      String wdailynews,
...
Future<void> EditCustomizeButton(  //save the edited data to the firebase
      String wtime,
      String wdate,
      String wweather,
      String wdailynews,
  ...
  Future<void> reminderAdding( //add the reminder to the firebase
    String _reminderTextController1, _reminderTextController2,_reminderTextController3,
  ) async {
    var collection = FirebaseFirestore.instance.collection('Person');
    collection
        .doc(userData?.uid) // <-- Doc ID where data should be updated.
